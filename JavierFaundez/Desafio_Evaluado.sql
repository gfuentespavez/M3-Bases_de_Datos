...
INSERT INTO peliculas (id, pelicula, año_estreno, director)
VALUES 
...
--RESPUESTA: POR LONGITUD DE RESPUESTA NO LA PUSE ACA, PERO SI ME RESULTO EL COMANDO!
SELECT actor 
FROM reparto
...
SELECT COUNT(peliculas) AS HR_PARTICIPATION
FROM peliculas 
...
--7.- Hacer una consulta SQL que muestre los títulos con su longitud, la longitud debe ser nombrado para la consulta como “longitud_titulo”.(OK)
